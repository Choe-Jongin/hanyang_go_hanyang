...
class Welfare_Building(Building):
    def __init__(self):
        super().__init__("학생복지관", 1, 4)
        self.set_texture('images/buildings/welfare.png')
        self.pos = (747, 370)
        self.center = (110, 178)    
        self.levelup_cost = [0,10000,20000,30000] 
        self.effect = [[0,0,0],[2,0,2],[4,1,4],[6,2,6],[8,3,8]]
        self.set_lveffect()
        ...
        #한 줄 소개
        self.dest = '내가 제일 좋아하는 복지관이다냥! 각종 식당부터 기념품샵까지 있으니 꼭 방문해라냥!'
